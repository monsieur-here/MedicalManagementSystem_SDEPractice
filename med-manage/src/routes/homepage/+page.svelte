...
{#if staff_type === "Receptionist"}
  <div class="grid">
    <div
      class="card"
      on:click={() => goto(`/registration?user_type=${user_type}`)}
      tabindex="0"
    >
    ...
    <div
      class="card"
      on:click={() => goto("/homepage/appointments?staff_type=Receptionist")}
      tabindex="0"
    >
    ...
    <div
      class="card"
      on:click={() => goto("/homepage/doctors?user_type=Staff")}
      tabindex="0"
    >
    ...
    <div
      class="card"
      on:click={() => goto("/homepage/room?user_type=Staff")}
      tabindex="0"
    >
      <h2>Book a Room</h2>
...
{:else if staff_type === "Doctor"}
  <div class="grid">
    ...
    <div
      class="card"
      on:click={() => goto("/homepage/appointments?staff_type=Doctor")}
      tabindex="0"
    >
      <h2>Appointment List</h2>
      <p>View and manage all patient appointments.</p>
